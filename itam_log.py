...
class logITAM:
    ...
    def test_realization(self,seed=1):
        ...
        #d_ng -= 1.
        d_ng -= N.exp(N.var(d_g)/2.)
        print('mean of nonlinear field=', N.mean(d_ng,axis=None), 'expected is 0.0')
...
if __name__== "__main__":
     itm = logITAM(boxsize=500.,ng=256, beta=0.5,Rth=5.0,eps=0.0007,Deps=0.0001,
            pathto_pk='data/planck_pk.txt', plotty=1)
